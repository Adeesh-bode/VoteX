...
// import Connect from '../assets/react.svg';
...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen w-screen flex gap-6 items-center justify-center bg-[#121215] p-6">
      <div className='bg-[#18181C] rounded-xl p-2 md:p-4 w-5/6 md:w-1/2 shadow-md flex flex-col gap-3 md:gap-5 justify-evenly items-center md:flex-row'>
        <div className='w-1/2 h-fit flex flex-col justify-between items-center'>
            {/* <div className="text-teal-400">Let's Connect</div> */}
            <img src={'/welcome.svg'} alt='interactive-img' />
        </div>
